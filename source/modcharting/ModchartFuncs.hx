...
class ModchartFuncs
{
    public static function loadLuaFunctions()
    {
        #if PSYCH
        #if LUA_ALLOWED
        for (funkin in 0...PlayState.instance.luaArray.length)
        {
            var luas = PlayState.instance.luaArray[funkin];
            if (luas != null){
            #if hscript
            luas.initHaxeModule();
            #end
        ...
        {
            FunkinLua.hscript.set('Math', Math);
            FunkinLua.hscript.set('PlayfieldRenderer', PlayfieldRenderer);
            FunkinLua.hscript.set('ModchartUtil', ModchartUtil);
            FunkinLua.hscript.set('Modifier', Modifier);
            FunkinLua.hscript.set('NoteMovement', NoteMovement);
            FunkinLua.hscript.set('NotePositionData', NotePositionData);
            FunkinLua.hscript.set('ModchartFile', ModchartFile);
        }
        #end
    ...
    public static function loadHScriptFunctions()
    {
        var game = PlayState.instance;
        game.setDefaultHScripts('Math', Math);
        game.setDefaultHScripts('PlayfieldRenderer', PlayfieldRenderer);
        game.setDefaultHScripts('ModchartUtil', ModchartUtil);
        game.setDefaultHScripts('ModchartFuncs', ModchartFuncs);
        game.setDefaultHScripts('Modifier', Modifier);
        game.setDefaultHScripts('NoteMovement', NoteMovement);
        game.setDefaultHScripts('NotePositionData', NotePositionData);
        game.setDefaultHScripts('ModchartFile', ModchartFile);
        game.setDefaultHScripts('setMod', setMod);
        game.setDefaultHScripts('startMod', startMod);
        game.setDefaultHScripts('setSubMod', setSubMod);
        game.setDefaultHScripts('setModTargetLane', setModTargetLane);
        game.setDefaultHScripts('setModPlayfield', setModPlayfield);
        game.setDefaultHScripts('addPlayfield', addPlayfield);
        game.setDefaultHScripts('removePlayfield', removePlayfield);
        game.setDefaultHScripts('tweenModifierSubValue', tweenModifierSubValue);
        game.setDefaultHScripts('tweenModifier', tweenModifier);
        game.setDefaultHScripts('setModEaseFunc', setModEaseFunc);
        game.setDefaultHScripts('setModchartEvent', set);
        game.setDefaultHScripts('easeModchartEvent', ease);
    }
