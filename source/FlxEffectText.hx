 ...
 * @author adrianulima
 */
class FlxEffectText extends FlxText//FUCK YOU HAXEFLIXEL
{
	/**
	 ...
	 */
	public var target(default, null):FlxText;
	 ...
	 */
	public function new(Target:FlxText, ?Effects:Array<IFlxEffect>)
	{
		super();
    ...
    private function cloneTarget():Void
        {
        this.x = target.x;
        this.y = target.y;
        ...
        this.systemFont = target.systemFont;
        this.bold = target.bold;
        this.italic = target.italic;
        this.wordWrap = target.wordWrap;
        this.alignment = target.alignment;
        this.borderStyle = target.borderStyle;
        this.borderColor = target.borderColor;
        this.borderSize = target.borderSize;
        this.borderQuality = target.borderQuality;
        this.textField = target.textField;
        this.fieldWidth = target.fieldWidth;
        this.autoSize = target.autoSize;
        this.shadowOffset = target.shadowOffset;
    }//?
}
