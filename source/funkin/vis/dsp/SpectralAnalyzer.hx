...
class SpectralAnalyzer {
	...
	public function changeSnd(audio:FlxSound) {
        this.audio = audio;
        @:privateAccess
        var audioSource = audio._channel.__audioSource;
		this.audioSource = audioSource;
		this.audioClip = new LimeAudioClip(audio);
	}
	...
	public function new(audio:FlxSound, barCount:Int, maxDelta:Float = 0.01, peakHold:Int = 30) {
        this.audio = audio;
        @:privateAccess
        var audioSource = audio._channel.__audioSource;
		this.audioSource = audioSource;
