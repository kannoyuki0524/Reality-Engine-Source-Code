            ...
            kind: FFun({
                ...
                expr: macro {
                    ...
                    for (filePath in Paths.getFolders(folder))
                    {
                        ...
                        {
                            _extensionScript = new FunkinHScript(fileName, path, true, _getScriptDefaultVars());
		...
		if (constructor!=null){
            switch (constructor.kind)
            {
                case FieldType.FFun(func):
                    ...
                    body.push(macro 
                        _startExtensionScript($v{folder}, $v{"extension/" + className})
                    );
