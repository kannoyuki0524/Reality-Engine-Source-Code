...
class FlxSound extends FlxBasic
{
	...
	function updateTransform():Void
	{
		...
		if (_channel != null)
		{
			...
			@:privateAccess
			if(#if (openfl >= "9.3.0") _channel.__audioSource #else _channel.__source #end != null)
			{
				#if cpp
				@:privateAccess
				#if (openfl >= "9.3.0") this._channel.__audioSource#else this._channel.__source#end.__backend.setPitch(_pitch);
...
#else
import flixel.sound.FlxSound as OriginalFlxSound;
typedef FlxSound = OriginalFlxSound;
#end